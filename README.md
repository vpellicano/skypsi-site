...
- The current page is the STEALTH GATE: wordmark + password field, content shipped AES-encrypted. Do not edit `index.html` by hand; it is generated by `site-src/build_gate.py` in the private `skypsi-website` repo. Edit `protected.html` there and rebuild.
